...
const WaveShape = () => {
    return (
        ...
        <div className="wave-container ">
            <div className="wave-banner container">
                <div>
                    <div>
                    ...
                    <button className='start-button rounded-full w-40 h-16 font-bold'> <Link to="../../Appointment/AvailableAppointments/AvailableAppointments.js">Get Started </Link></button>
                ...
                <svg className="wave-curve container"
